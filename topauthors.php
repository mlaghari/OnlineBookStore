...
include("session.php");
    $limit = $_POST['limit'];
    $query = mysql_query("select Name, A.AuthorID, A.count as NumberOfBooks from authors, (select AuthorID, count(AuthorID) as count 
                from authorbooks group by AuthorID order by count desc Limit $limit) as A
                where A.AuthorID = authors.AuthorID");
?>
<!DOCTYPE html>
<html lang="en">
