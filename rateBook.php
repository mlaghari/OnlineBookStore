...
$isbn = $_POST['book'];
$q1 = mysql_query("ALTER TABLE `feedback` AUTO_INCREMENT = 1");
$query = mysql_query("INSERT INTO feedback(`ISBN`,`Rating`,`Comments`,`UserID`)
        VALUES('$isbn','$quantity','$comment',$session_id)");
$check = mysql_query("Select * from feedback where ISBN = '$isbn' and UserID = '$session_id'");
...
<div class="navbar navbar-default navbar-fixed-top">
    ...
    <!-- Page Content -->
<div class="container">
        <h1>Your Rating has been recorded.</h1>
        <!-- /.row -->
        <br><br>
        <hr class="prettyline">
