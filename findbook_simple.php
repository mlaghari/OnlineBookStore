<?php 
    ...
    if(isset($_POST['bookname'])){ 
    	$book = $_POST['bookname'];
    	$query=mysql_query("select * from books as b where b.ISBN = '$book' OR b.Title like '%$book%' OR 
            b.ISBN IN (select ISBN from authorbooks as ab 
             where ab.AuthorID IN (select AuthorID from authors as a where a.Name like '%$book%')) OR b.Publisher like '%$book%'");
	    $rows=mysql_num_rows($query);
	    if ($rows > 0) {
	        $_SESSION['results'] = $query;
	        // header("Location:results_books_s.php"); 
	    } else {
	    	echo $rows;
                                ...
                                <div class="navbar-login">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            ?>
                                                <!-- <a href="admin_profile.php" class="btn btn-primary btn-block btn-sm">Profile</a> -->
                                            </p>
                                        </div>
                                    </div>
                                </div>
